<script type="text/javascript">document.title = "Yasu - Skins"</script>
<?php
...
<form method="post">
  ...
  <h1 align="center" style=" font-variant: small-caps; font-weight: bold;">Choose a skin</h1>
...
<div class="text-center">
  ...
  value="" id="skinCost">Obtained!</button>
</div>
</form>
...
$('#carouselExampleCaptions').on('slid.bs.carousel', function() {
   ...
   switch(currentIndex){
    case 1:
      ...
      document.getElementById("skinCost").innerText = "Obtained!";
    ...
    case 2:
      ...
      if (skin=="1") {
        ...
        document.getElementById("skinCost").innerText = "Buy";
