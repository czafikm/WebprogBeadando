<script type="text/javascript">document.title = "Yasu - Message"</script>
<?php 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 id="messageTitle" class="modal-title w-100 font-weight-bold">Message</h4>
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <label id="messageRecipient"  data-error="wrong" data-success="right" for="form34">Recipient</label>
        </div>
        <div class="md-form mb-5">
          <i class="fas fa-tag prefix grey-text"></i>
          <input type="text" id="form32" class="form-control validate" name="subject" value="<?=isset($postData) ? $postData['subject'] : "";?>">
          <label id="messageSubject" data-error="wrong" data-success="right" for="form32">Subject</label>
        </div>

        <div class="md-form">
          <i class="fas fa-pencil prefix grey-text"></i>
          <textarea type="text" id="form8" class="md-textarea form-control" rows="5" name="message"><?=isset($message) ? $message : "";?></textarea>
          <label id="messageContent" data-error="wrong" data-success="right" for="form8">Content</label>
        </div>

      </div>
      <div class="modal-footer d-flex justify-content-center">
        <button type="submit" name="sendMessage" id="messageBtn" class="btn btn-unique"><i class="fas fa-paper-plane-o ml-1">Send message</i></button>
      </div>
    </div>
  </div>
</div>
...
<div class="text-center">
  <a id="newMessage" href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#modalContactForm">New message</a>
</div>
  </div>
<table id="messageTable">
<tbody>
  <tr>
    <th class="tg-0lax"><a id="Inbox" href="index.php?P=inbox">Inbox</a></th>
  </tr>
  <tr>
    <th class="tg-0lax"><a id="Outbox" href="index.php?P=outbox">Outbox</a></th>
  </tr>
</tbody>
</table>
</div>
