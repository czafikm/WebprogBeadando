<script type="text/javascript">document.title = "Yasu - Profile"</script>
<?php 
  ...
  switch ($character['skin']) {
    case '0':?>
          ...
          <img src="<?=PUBLIC_DIR.'Images/yasuo-default.jpg'?>" width="15%" class="d-block" alt="Default">
              <div>
                <h5 style=" font-variant: small-caps; font-weight: bold;">Default</h5>
              </div>
            </div><?php
      break;
      case '1':?>
...
?>
  <?php
  if(empty($character)) :
    echo "Error loading the character!";
  else :?>
    <div align="center">
    <hr>
