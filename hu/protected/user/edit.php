			...
			<form method="post">
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						<label for="userEmail">Felhasználónév</label>
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						<label for="userPermission">Engedély</label>
						<input type="text" class="form-control" id="userPermission" name="permission" value="<?=$user['permission'] ?>" >
					</div>
				</div>
				<div class="col text-center">
					<button type="submit" class="btn btn-primary col-md-3" name="editUser" >Mentés</button>
				</div>
				</div>
			</form>
	<?php endif;
