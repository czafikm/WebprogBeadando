<script type="text/javascript">document.title = "Yasu - Karakter"</script>
<?php 
...
?>
  ...
  <h1 align="center" style=" font-variant: small-caps; font-weight: bold;">Kinézetek</h1>
...
var activeSkin = "<?php echo $character['skin'] ?>";
  ...
  case '0':
    ...
    break;
          ...
          <img src="<?=IMAGE_DIR.'yasuo-default.jpg'?>" width="15%" class="d-block" alt="Default">
...
<script type="text/javascript">
  ...
  case '1':
    ...
    break;
          ...
          <img src="<?=IMAGE_DIR.'yasuo-blood-moon.jpg'?>" width="15%" class="d-block" alt="Blood Moon">
      <div class="carousel-caption d-none d-md-block">
        <h5>Blood Moon</h5>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  case '2':
    ...
    break;
        ...
        <img src="<?=IMAGE_DIR.'yasuo-high-noon.jpg'?>" width="15%" class="d-block" alt=">High Noon">
      <div class="carousel-caption d-none d-md-block">
        <h5>High Noon</h5>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  case '3':
    ...
    break;
        ...
        <img src="<?=IMAGE_DIR.'yasuo-odyssey.jpg'?>" width="15%" class="d-block" alt="Odyssey">
      <div class="carousel-caption d-none d-md-block">
        <h5>Odyssey</h5>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  case '4':
    ...
    break;
            ...
            <img src="<?=IMAGE_DIR.'yasuo-battleboss.jpg'?>" width="15%" class="d-block " alt="Battleboss">
      <div class="carousel-caption d-none d-md-block">
        <h5>Battleboss</h5>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  document.getElementById("skinCost").innerText = "Aktiválva!";
...
function gombok(){
    ...
    case 1:
      ...
      document.getElementById("skinCost").innerText = "Aktiválás!";
    }
    ...
    case 2:
      ...
      document.getElementById("skinCost").innerText = "Aktiválás!";
        ...
        document.getElementById("skinCost").disabled = true;
        document.getElementById("skinCost").innerText = "Nincs megszerezve!";
