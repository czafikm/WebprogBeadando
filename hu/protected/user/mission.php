<script type="text/javascript">document.title = "Yasu - Küldetés"</script>
<?php 
...
<h1 id="missionTitle" align="center" style=" font-variant: small-caps; font-weight: bold; margin-bottom: 20px;">Küldetés</h1>
<form method="post">
	  <div class="text-center">
  		<label id="missionLabel" for="missionTime">Válaszd ki mennyi időre szeretnél küldetésre menni: </label>
	  	<select name="missionTime" id="missionTime">
		    <option id="1hour" value="1">1 óra</option>
		    <option id="2hour" value="2">2 óra</option>
		    <option id="4hour" value="4">4 óra</option>
		    <option id="6hour" value="6">6 óra</option>
	  	</select>
		<div class="col text-center" style="padding-top: 20px;">
			<button type="submit" class="btn btn-primary col-md-2" name="startMission" >ZSAMÓ!</button>
		</div>
  	  </div>
</form>
<?php else: ?>
